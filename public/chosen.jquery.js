...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      if (this.options.checkbox) {
        option_el.innerHTML = '<label title="'+option.search_text+'"><input type="checkbox">' + option.search_text + '</label>'
      } else {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results'+(this.columns !== 'auto' ? " "+columns_classes : "")+(this.column_width !== 'auto' ? " "+column_width_classes : "")+'"></ul></div>');
      } else {
	...
	Chosen.prototype.setup_columns = function() {
	  if(this.columns !== 'auto') {
		...
		this.dropdown.addClass("column-overrides");
	  } else {
